...
\makeindex[name=R,title=Responsoria, columns=2,columnseprule, options=-s dotted.ist]
...
\setmainfont[Ligatures=TeX]{Charis} % changer pour changer la police
...
\newcommand{\modeannotation}[1]{
  ...
  \grenewcommand{\nextpsalmmode}{#1}
  \changemode{#1}{1a}{1}{Ia}{1}
  \changemode{#1}{1b}{1}{Ib}{1}
  \changemode{#1}{1c}{1}{Ic}{1}
  \changemode{#1}{1}{1}{I}{1}
  \changemode{#1}{2}{2}{II}{2}
  \changemode{#1}{3a}{3}{IIIa}{3}
  \changemode{#1}{3b}{3}{IIIb}{3}
  \changemode{#1}{3c}{3}{IIIc}{3}
  \changemode{#1}{3}{3}{III}{3}
  \changemode{#1}{4a}{4}{IVa}{4}
  \changemode{#1}{4b}{4}{IVb}{4}
  \changemode{#1}{4c}{4c}{IVc}{4}
  \changemode{#1}{4}{4}{IV}{4}
  \changemode{#1}{5}{5}{V}{5}
  \changemode{#1}{6}{6}{VI}{6}
  \changemode{#1}{7a}{7}{VIIa}{7}
  \changemode{#1}{7b}{7}{VIIb}{7}
  \changemode{#1}{7c}{7}{VIIc}{7}
  \changemode{#1}{7}{7}{VII}{7}
  \changemode{#1}{8a}{8}{VIIIa}{8}
  \changemode{#1}{8b}{8}{VIIIb}{8}
...
%% et indexe la pièce selon son office-part et son mode
\begin{luacode*}
...
% this command is called every time the left and right header texts are set (e.g. by calling \festum)
