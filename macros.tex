...
%% Rubriques
\newcommand{\rubrica}[1]{\hspace*{0.04\textwidth}\textcolor{gregoriocolor}{{\footnotesize #1}}\par}
...
\newcommand{\capitulum}[2]{%
	...
	\hspace*{0.04\textwidth}% retrait avant d'imprimer "capitulum". Voir aussi le retrait des rubriques.
	...
	\rdrop #2
	\vspace{2mmplus 1.5mmminus 1.5mm}
}
...
% \newcommand{\compositio}[1]{} %% activer ceci pour désactiver les ajustements fins
% \newcommand{\destructio}[1]{#1} %% activer ceci pour désactiver les ajustements fins par suppresion
\newcommand{\compositio}[1]{#1} %% activer ceci pour activer les ajustements fins
\newcommand{\destructio}[1]{} %% activer ceci pour activer les ajustements fins par suppresion