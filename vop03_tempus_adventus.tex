...
\compositio{\null\newpage}%pour commencer sur une page de gauche
...
\rubrica{Sabbato ante Dominicam I Adventus, Officium in dextro choro inchoatur, subinde per totum annum, singulis Sabbatis, ab uno choro ad alium alternatim ante Vesperas transferendum.}

\cantusilluminatio[round]{2}
\cantus{A1F0VR}{\rrann}

\rubrica{Capitulum \normaltext{Ecce dies véniunt,} hymnus \normaltext{Cónditor} et \vvrub \normaltext{Roráte,} ut in Psalterio \normaltext{\pageref{M-AVH},} in Vesperis dicantur quotidie per Adventum, cum de Tempore agitur. Oratio vero dominicæ præcedentis, nisi aliter notetur.}
...
\compositio{\vfill\lineamagna\vfill}
